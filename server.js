...
// ==========================================================
const SECRET_ACCESS_KEY = "MySecretPassword123";

// Put your approved User IDs inside this array as strings
const whitelist = [
    "12345678", 
    "87654321"
];
...
app.listen(PORT, () => console.log(`Active Security Gateway running on port ${PORT}`));    end
    return Original_GMHelper_onAppActionTrigger(type, params)
end
